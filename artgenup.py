...
# ---------------------------
OPENAI_API_KEY = "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"   
...
def crawl_google_links(topic, num_links=5):
    """
    جستجو در گوگل بر اساس موضوع و بازگرداندن لینک‌های یکتا که تبلیغاتی (Ads یا sponsored) نباشند.
    """
    links = []
    try:
        query = topic
